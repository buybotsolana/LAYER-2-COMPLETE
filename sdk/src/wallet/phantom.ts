...
export class PhantomWalletAdapter implements WalletAdapter {
  ...
  /**
   * Costruttore della classe PhantomWalletAdapter
   */
  constructor() {
    // Verifica se Phantom è disponibile nel browser
    if (typeof window !== 'undefined' && window.solana && window.solana.isPhantom) {
      ...
      console.warn('Phantom non è installato o non è disponibile');
    }
  }
  ...
  async connect(): Promise<void> {
    if (!this.wallet) {
      throw new Error('Phantom non è installato o non è disponibile');
    }
    ...
    try {
      ...
      console.error('Errore nella connessione a Phantom:', error);
      throw error;
    }
  }
  ...
  async disconnect(): Promise<void> {
    ...
    try {
      ...
      console.error('Errore nella disconnessione da Phantom:', error);
      throw error;
    }
  }
  ...
  async signTransaction(transaction: Transaction): Promise<Transaction> {
    ...
    try {
      ...
      console.error('Errore nella firma della transazione con Phantom:', error);
      throw error;
    }
  }
  ...
  async signMessage(message: Uint8Array): Promise<Uint8Array> {
    ...
    try {
      ...
      console.error('Errore nella firma del messaggio con Phantom:', error);
      throw error;
    }
  }
  ...
  async sendTransaction(transaction: Transaction): Promise<string> {
    ...
    try {
      ...
      console.error('Errore nell\'invio della transazione con Phantom:', error);
      throw error;
    }
  }
